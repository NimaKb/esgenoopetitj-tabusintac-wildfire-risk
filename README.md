...
Fire Exposure and Directional Vulnerability is a published and reliable way to evalute the exposure, vulnerability, and risk for different scales. To better understand the method and its details, you can visit these publications here:  
...
Seasonal Fire Weather and Windrose Analysis (to be added)
...
- Both datasets use wind direction (WD) as input for angular bins

**Define Binning Thresholds and Color Scheme:**
- FWI: 0–5, 5–10, 10–19, 19–30, 30+  
- ISI: 0–2, 2–4, 4–8, 8–15, 15+  
- Uses "YlOrRd" palette for intuitive intensity grading
...
- Produces four seasonal plots:
  ...
  - Summer/Fall FWI  
  - Summer/Fall ISI  
- Uses openair::windRose() for polar plots with frequency-weighted coloring
